...
urlpatterns = [
    ...
    path('experiment/<int:exp_id>/word_edit_stimuli',
         views.word_edit_stimuli, name='word_edit_stimuli'),
    ...
    path('api/contrasts/<slug:username>', rest_views.user_contrast_list),
    ...
    path('api/experiment/<int:exp_id>/reject',
